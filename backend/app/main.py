...
from app.utils.fix_users import ensure_user_encryption_keys, add_missing_columns   # ← added add_missing_columns
...
async def startup():
    ...
    try:
        ...
        ensure_user_encryption_keys()        # ← ensures every user has an encryption key
