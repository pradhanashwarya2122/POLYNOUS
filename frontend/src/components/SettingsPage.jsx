...
const PROVIDERS = {
  ...
  openai:    { label: "OpenAI GPT",        icon: "smart_toy",      color: C.cyan,     placeholder: "sk-…",
               models: ["gpt-4o-mini", "gpt-5.1", "gpt-5.2", "gpt-5.4", "gpt-5.5"] },
  ...
  zhipu:     { label: "Zhipu AI (GLM)",    icon: "hexagon",        color: C.purple,   placeholder: "Zhipu API key…",
               models: ["glm-4.7", "glm-4.6", "glm-5.1", "glm-5.2"] },
