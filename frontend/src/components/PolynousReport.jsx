...
function provenanceRows(d) {
  ...
  return items.map((s) => `<div class="flex items-center justify-between gap-3"><div class="flex items-center gap-2 min-w-0"><span class="w-1.5 h-1.5 rounded-full bg-app-primary shrink-0"></span><span class="text-[12.5px] text-white/85 capitalize truncate">${esc(s.name)}</span></div><span class="text-[11px] font-mono text-[#5C687C] shrink-0">${s.tokens ? s.tokens.toLocaleString() + " tok" : ""}</span></div>`).join("");
}
...
<div class="bg-[#121226] border border-app-border rounded-lg p-6 flex flex-col col-span-1" id="evidence-strength"><h3 class="text-[12px] uppercase tracking-wider text-white mb-5">EVIDENCE STRENGTH SCALE</h3><div class="flex flex-col gap-5 mt-1"><div class="flex items-center justify-between"><div class="flex items-center gap-3"><i class="ph ph-shield-check text-app-success text-lg"></i><div class="flex gap-1"><div class="h-1.5 w-7 bg-app-success rounded-sm"></div><div class="h-1.5 w-7 bg-app-success rounded-sm"></div><div class="h-1.5 w-7 bg-app-success rounded-sm"></div></div></div><span class="text-[12px] font-mono text-white">90%</span></div><div class="flex items-center justify-between"><div class="flex items-center gap-3"><i class="ph ph-shield-plus text-app-primary text-lg"></i><div class="flex gap-1"><div class="h-1.5 w-7 bg-app-primary rounded-sm"></div><div class="h-1.5 w-7 bg-app-primary rounded-sm"></div><div class="h-1.5 w-7 bg-app-border rounded-sm"></div></div></div><span class="text-[12px] font-mono text-white">66%</span></div><div class="flex items-center justify-between"><div class="flex items-center gap-3"><i class="ph ph-shield text-app-success text-lg"></i><div class="flex gap-1"><div class="h-1.5 w-7 bg-app-success rounded-sm"></div><div class="h-1.5 w-7 bg-app-success rounded-sm"></div><div class="h-1.5 w-7 bg-app-border rounded-sm"></div></div></div><span class="text-[12px] font-mono text-white">66%</span></div><div class="flex items-center justify-between"><div class="flex items-center gap-3"><i class="ph ph-shield-warning text-app-warning text-lg"></i><div class="flex gap-1"><div class="h-1.5 w-7 bg-app-warning rounded-sm"></div><div class="h-1.5 w-7 bg-app-border rounded-sm"></div><div class="h-1.5 w-7 bg-app-border rounded-sm"></div></div></div><span class="text-[12px] font-mono text-white">33%</span></div></div></div>
</div>
